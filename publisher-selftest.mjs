...
has(publication,"status:{privacyStatus:'private',selfDeclaredMadeForKids:false,containsSyntheticMedia:true}",'YouTube upload is plain PRIVATE with native synthetic-media disclosure');
...
must(schema.properties?.publication?.properties?.ai_disclosure_required?.const===true,'native AI disclosure must be globally required');
