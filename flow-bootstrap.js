...
if(!globalThis.__publisherFlowBootstrapInstalled){
 ...
 express.application.listen=function(...args){
  ...
  app.get('/flow/bootstrap/view',(_req,res)=>{try{
    ...
    res.type('html').send('<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=1024,initial-scale=1"><meta http-equiv="refresh" content="1.2"><style>*{box-sizing:border-box}html,body{margin:0;width:1024px;min-height:700px;background:#ececeb;overflow:auto}form{margin:0;width:1024px;height:700px}input[type=image]{display:block;width:1024px;height:700px;border:0;padding:0;margin:0;background:#ececeb}</style></head><body><form method="post" action="/flow/bootstrap/click-view"><input type="image" name="screen" src="/flow/bootstrap/screen.png?t='+Date.now()+'" width="1024" height="700" alt="Navegador remoto"></form></body></html>');
