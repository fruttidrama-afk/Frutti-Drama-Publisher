...
COPY runtime-config.js runtime-init.js free-browser-provider.js flow-bootstrap.js server.js publication.js publication-copy.js publisher-selftest.mjs publisher.config.schema.json ./
