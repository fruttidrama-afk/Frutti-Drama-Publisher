...
*{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--ink);font-family:Arial,Helvetica,sans-serif;padding:calc(18px + env(safe-area-inset-top)) 16px calc(40px + env(safe-area-inset-bottom));-webkit-font-smoothing:antialiased}.wrap{max-width:860px;margin:auto}.brandhead{display:flex;align-items:center;gap:14px;margin:0 0 18px}.brandhead img{width:64px;height:64px;object-fit:contain;border-radius:16px;background:var(--surface)}.brandhead strong{font:400 26px Georgia,serif;color:var(--navy)}.brandref{width:100%;height:140px;object-fit:cover;border:1px solid var(--line);margin:0 0 18px;display:${brand.reference_image_url?"block":"none"}}.back{display:inline-flex;color:var(--navy);text-decoration:none;font-weight:800;margin-bottom:18px}.eyebrow{font-size:11px;letter-spacing:.22em;color:var(--gold);font-weight:800}
...
.hero-note{background:var(--surface);border:1px solid var(--line);padding:15px 16px;margin:18px 0 24px;display:flex;gap:12px;align-items:flex-start}.hero-note .dot{width:12px;height:12px;border-radius:50%;background:var(--gold);margin-top:4px;flex:0 0 auto}.hero-note p{margin:0;color:var(--muted);line-height:1.5}
